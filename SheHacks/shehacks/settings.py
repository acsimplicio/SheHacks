"""
Django settings for shehacks project.
...
WSGI_APPLICATION = 'shehacks.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './shehacks.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
